...
KNOBS = [
    ...
    {"section": "repository_updater", "key": "enabled", "type": "bool",
     ...
     "desc": "Poll for fast-forward repository updates while safely idle."},
    {"section": "repository_updater", "key": "repo_path", "type": "str",
     "default": os.path.dirname(BASE_DIR), "env": "PICARX_UPDATE_REPO",
     "desc": "Absolute checkout path to update.", "config_default": None},
    {"section": "repository_updater", "key": "remote", "type": "str",
     "default": "origin", "env": "PICARX_UPDATE_REMOTE",
     "desc": "Git remote used by the updater."},
    {"section": "repository_updater", "key": "branch", "type": "str",
     "default": "master", "env": "PICARX_UPDATE_BRANCH",
     "desc": "Fast-forward-only branch used by the updater."},
    {"section": "repository_updater", "key": "poll_interval_sec", "type": "float",
     "default": 3600.0, "env": "PICARX_UPDATE_INTERVAL",
     "desc": "Seconds between automatic update checks when enabled."},
